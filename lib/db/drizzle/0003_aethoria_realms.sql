ALTER TABLE "aethoria_locations" ADD COLUMN IF NOT EXISTS "realm" text DEFAULT 'Unknown Realm' NOT NULL;
--> statement-breakpoint
ALTER TABLE "aethoria_locations" ADD COLUMN IF NOT EXISTS "primary_faction" text DEFAULT 'Uncharted faction' NOT NULL;
--> statement-breakpoint
